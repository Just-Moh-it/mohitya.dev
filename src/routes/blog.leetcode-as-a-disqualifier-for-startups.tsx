...
export const Route = createFileRoute("/blog/leetcode-as-a-disqualifier-for-startups")({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "/og/leetcode-as-a-disqualifier-for-startups.png" },
      ...
      { name: "twitter:image", content: "/og/leetcode-as-a-disqualifier-for-startups.png" },
    ],
  }),
